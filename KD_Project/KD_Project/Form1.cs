...
namespace KD_Project
{
   ...
   */
        ...
        private static bool commonWordTest(string s)
        {
            ...
            HashSet<string> hash = new HashSet<string>(common.ToLower().Split(new char[] {' '}, StringSplitOptions.RemoveEmptyEntries));
        ...
        */
        ...
        private void DownloadComplete(Object sender, DownloadStringCompletedEventArgs e)
        {
            ...
            doc.LoadHtml(HttpUtility.HtmlDecode(e.Result));
            ...
            */
            ...
            ns = s.SelectNodes("p/a");
            foreach (HtmlNode link in ns)
            {
