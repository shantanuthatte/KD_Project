...
@rem !! @path=C:\Program Files\Path_to_the_compiler;%path%
...
@rem !! Exclude "/debug:full /o-" options from the following line to optimize bot performance after having debugged it
