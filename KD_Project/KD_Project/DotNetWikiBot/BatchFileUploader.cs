// MassFileUploader.cs - .NET 2.0 C# script, based on DotNetWikiBot Framework
// This script uploads batch of files, found in specified folder, to MediaWiki-powered wiki site
// Typical compilation command: csc.exe /target:winexe BatchFileUploader.cs /reference:DotNetWikiBot.dll
// Distributed under the terms of the MIT (X11) license: http://www.opensource.org/licenses/mit-license.php
// Copyright © Iaroslav Vassiliev (Moscow, 2009) codedriller@gmail.com
...
public class UploadForm : Form
{
	...
	public UploadForm()
	{
		...
		siteTextBox.Text = "wiki.domain.com";
